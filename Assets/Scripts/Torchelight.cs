...
public class Torchelight : MonoBehaviour
{
    ...
    {
        TorchLight.GetComponent<Light>().intensity = PlayerPrefs.GetInt("PlayerIllumination");
        TorchLight.GetComponent<Light>().range = PlayerPrefs.GetInt("PlayerIllumination");
        MaxLightIntensity = PlayerPrefs.GetInt("PlayerIllumination");
    }
}
